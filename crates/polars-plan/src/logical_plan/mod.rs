...
impl Clone for DslPlan {
    ...
    fn clone(&self) -> Self {
        match self {
            ...
            Self::Scan { paths, file_info, predicate, file_options, scan_type, with_policy } => Self::Scan { paths: paths.clone(), file_info: file_info.clone(), predicate: predicate.clone(), file_options: file_options.clone(), scan_type: scan_type.clone() , with_policy: with_policy.clone()},
